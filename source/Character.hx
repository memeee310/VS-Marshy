	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
		   case 'marshy':
				// MARSHY ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('Marshy','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Marshy idle dance', 24);
				animation.addByPrefix('singUP', 'Marshy Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Marshy Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'Marshy Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'Marshy Sing Note LEFT', 24);

				loadOffsetFile(curCharacter);

				playAnim('idle');
			case 'invisible-man':
				// INVISIBLE MAN ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('Invisible-man','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Invisible-man idle dance', 24);
				animation.addByPrefix('singUP', 'Invisible-man Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Invisible-man Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'Invisible-man Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'Invisible-man Sing Note LEFT', 24);
