...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'outdoors-pixel': //For Pixelated Dream
			GameOverSubstate.deathSoundName = 'fnf_loss_sfx-pixel';
			GameOverSubstate.loopSoundName = 'gameOver-pixel';
			GameOverSubstate.endSoundName = 'gameOverEnd-pixel';
			GameOverSubstate.characterName = 'bf-pixel-dead';
			...
			var bghouse:BGSprite = new BGSprite('outdoors-pixel/outdoorspixel', repositionShit, 0, 0.6, 0.90);
			add(bghouse);
			bghouse.antialiasing = false;

			var bgground:BGSprite = new BGSprite('outdoors-pixel/groundpixel', repositionShit, 0, 0.95, 0.95);
			add(bgground);
			bgground.antialiasing = false;
			...
			bgOutSky.setGraphicSize(widShit);
			bgground.setGraphicSize(widShit);

			bghouse.updateHitbox();
			bgOutSky.updateHitbox();
